...
export const featuredProjects = [
    {
        ...
        logo: "M",
        color: "bg-[#102c1e] text-[#fafafa]", // Đổi từ blue sang Dark Green
        points: 263
    },
    {
        id: "f2",
        ...
        logo: "T",
        color: "bg-[#a1e2b6] text-[#102c1e]", // Accent Xanh ngọc
        points: 158,
        tag: "Sponsored"
    }
];

// --- Dữ liệu cho Main Feed ---
export const timelineProjects = [
    ...
    },
    {
        ...
        name: "CropGuard",
        logo: "C",
        color: "bg-[#102c1e]/80", // Nhạt hơn 1 xíu để phân cấp
...
// (Giữ nguyên mảng topMentors và topInvestors như cũ)
// ...
