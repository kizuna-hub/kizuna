...
export function FeedWidgets() {
    return (
        <div className="flex flex-col gap-8">
            ...
            <div>
                <h2 className="mb-4 text-sm font-black font-outfit text-[#102c1e]">Activity streak</h2>
                <div className="rounded-2xl border border-[#102c1e]/10 bg-white p-5 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="text-lg font-bold font-geist text-[#102c1e]">
                                1 consecutive days
                            </h3>
                            <p className="mt-0.5 text-xs font-medium text-slate-500 font-geist">6 more days to reach the next milestone!</p>
                        </div>
                    </div>

                    <div className="mt-6 flex items-center justify-between text-[10px] font-bold text-slate-400 font-geist">
                    ...
                    <button className="mt-4 flex items-center gap-1 text-xs font-bold font-geist text-slate-500 hover:text-[#102c1e] transition-colors">
            ...
            {/* Reviews Widget */}
            <div>
                <h2 className="mb-4 text-sm font-black font-outfit text-[#102c1e]">Kizuna Reviews</h2>
                <div className="flex flex-col gap-4 rounded-2xl border border-[#102c1e]/10 bg-white p-5 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="flex gap-3">
                        ...
                        <div>
                            <p className="text-sm font-bold font-geist text-[#102c1e] leading-snug">Giải pháp tối ưu hóa trải nghiệm IOS</p>
                            <div className="mt-1 flex items-center gap-2 text-xs font-medium text-slate-500 font-geist">
                    ...
                    <div className="flex gap-3">
                        ...
                        <div>
                            <p className="text-sm font-bold font-geist text-[#102c1e] leading-snug">Đánh giá chi tiết nền tảng AI Roleplay</p>
                            <div className="mt-1 flex items-center gap-2 text-xs font-medium text-slate-500 font-geist">
