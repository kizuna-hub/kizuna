...
import {
    Search, LayoutDashboard, Package, Users, Home,
    Compass, Flame, Settings, HelpCircle
} from "lucide-react";
            ...
            <aside className="fixed left-0 top-0 flex h-screen w-[260px] flex-col border-r border-white/5 bg-kizuna-primary z-40">
                ...
                <div className="p-4 flex flex-col gap-6 border-b border-white/5">
                    ...
                    <Link href="/" className="flex items-center gap-2 px-1 cursor-pointer group">
                        ...
                        <span className="font-outfit text-base font-bold tracking-wide text-[#fafafa]">Kizuna Hub</span>
                    </Link>
                    ...
                    >
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-geist text-sm font-bold">Search Or Create</span>
                        </div>
                ...
                <div className="flex-1 overflow-y-auto p-3 [&::-webkit-scrollbar]:hidden flex flex-col gap-6 mt-1">
                    ...
                    {/* PLATFORM */}
                    <div>
                        <p className="mb-2 px-3 text-[10px] font-bold uppercase tracking-widest text-white/50 font-geist">Platform</p>
                        <div className="flex flex-col gap-0.5">
                            <NavItem icon={LayoutDashboard} label="Overview" href="/founder/founder-dashboard" exact={true} />
                            <NavItem icon={Package} label="Products" href="/founder/founder-dashboard/products" />
                            <NavItem icon={Users} label="Teams" href="/founder/founder-dashboard/teams" />
                        </div>
                    </div>

                    {/* ACCOUNT */}
                    <div>
                        <p className="mb-2 px-3 text-[10px] font-bold uppercase tracking-widest text-white/50 font-geist">Account</p>
                        <div className="flex flex-col gap-0.5">
                ...
                <div className="border-t border-white/5 p-4 flex flex-col gap-4 bg-kizuna-primary">
                    ...
                    <div className="rounded-xl bg-[#fafafa] p-3 shadow-sm">
                        <div className="flex items-center justify-between mb-2">
                            <span className="font-geist text-sm font-bold text-[#102c1e] flex items-center gap-1.5">
                                <Flame className="w-3.5 h-3.5 text-[#102c1e]" /> Lv.{user.level}
                            </span>
                            <span className="font-geist text-xs font-bold text-[#102c1e]/60">{user.points} pts</span>
                        </div>
                        ...
                        <p className="mt-2 font-geist text-[10px] font-bold text-[#102c1e]/60">
                            {user.nextLevelPoints} more → Lv.{user.level + 1}
                        </p>
                    </div>
                    ...
                    <button className="flex items-center gap-3 px-2 py-1 rounded-lg hover:bg-white/10 transition-colors cursor-pointer group text-left">
                        ...
                        <div className="flex-1 min-w-0 flex flex-col">
                            ...
                            <p className="font-geist text-xs font-medium text-white/60 truncate">{user.handle}</p>
                        </div>
                    </button>
                </div>
