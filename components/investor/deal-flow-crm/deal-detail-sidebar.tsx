        ...
        <>
            ...
            <div className="fixed inset-y-0 right-0 w-full max-w-2xl bg-white shadow-2xl z-50 overflow-y-auto flex flex-col transform transition-transform animate-in slide-in-from-right duration-300">
                ...
                <div className="sticky top-0 z-10 bg-white border-b border-slate-100 px-8 py-6 flex items-start justify-between">
                    <div>
                        <div className="flex items-center gap-2 mb-3">
                            <span className={cn("px-2.5 py-1 rounded-md border font-geist text-[10px] font-bold uppercase tracking-wide", getPriorityColor(deal.priority))}>
                                {deal.priority} Priority
                            </span>
                            <span className="px-2.5 py-1 rounded-md border border-slate-200 bg-slate-50 font-geist text-[10px] font-bold text-slate-500 uppercase tracking-wide">
                                Stage: {deal.stage}
                            </span>
                            {deal.matchScore && (
                                <span className="px-2.5 py-1 rounded-md bg-[#a1e2b6]/20 border border-[#a1e2b6]/40 font-geist text-[10px] font-black text-[#102c1e] uppercase tracking-wide">
                                    {deal.matchScore}% Match
                                </span>
                            )}
                        </div>
                        <h2 className="font-outfit text-2xl font-black text-[#102c1e]">
                            {deal.startup}
                        </h2>
                ...
                <div className="p-8 space-y-10 flex-1">
                    ...
                    <div>
                        <h4 className="font-geist text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-3">Project Overview</h4>
                        <p className="font-inter text-sm text-[#102c1e] font-bold mb-1">{deal.tagline}</p>
                    ...
                    <div>
                        <h4 className="font-geist text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-3 flex items-center gap-2">
                            Traction & Metrics <span className="px-1.5 py-0.5 rounded-full bg-slate-100 text-slate-500 text-[9px]">4</span>
                        </h4>
                        <div className="flex flex-wrap gap-2">
                            <span className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-200 bg-white font-geist text-xs font-bold text-[#102c1e]">
                        ...
                        <div className="grid grid-cols-3 gap-4 mt-4">
                            <div className="border border-slate-100 bg-slate-50 rounded-xl p-4">
                                <p className="font-geist text-[9px] text-slate-400 font-bold uppercase tracking-widest mb-1">Market Fit</p>
                                <p className="font-outfit text-lg font-black text-[#102c1e]">Strong</p>
                            </div>
                            <div className="border border-slate-100 bg-slate-50 rounded-xl p-4">
                                <p className="font-geist text-[9px] text-slate-400 font-bold uppercase tracking-widest mb-1">Burn Rate</p>
                                <p className="font-outfit text-lg font-black text-[#102c1e]">~$8K/mo</p>
                            </div>
                            <div className="border border-slate-100 bg-slate-50 rounded-xl p-4">
                                <p className="font-geist text-[9px] text-slate-400 font-bold uppercase tracking-widest mb-1">Competitors</p>
                                <p className="font-outfit text-lg font-black text-[#102c1e]">Moderate</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <h4 className="font-geist text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-3">AI Sourcing Analysis</h4>
                        <ol className="space-y-2.5 font-inter text-sm text-slate-600">
                    ...
                    <div>
                        <h4 className="font-geist text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-3">Team & Contact</h4>
                        <div className="bg-slate-50 border border-slate-100 rounded-xl p-5">
                            <div className="flex items-start gap-4 mb-4">
                                <div className="w-12 h-12 rounded-full bg-[#102c1e]/10 flex items-center justify-center shrink-0">
                                    <span className="font-geist text-lg font-black text-[#102c1e]">
                                        {deal.founder.charAt(0)}
                                    </span>
                                </div>
                                <div>
                                    <h5 className="font-outfit font-bold text-[#102c1e] text-base">{deal.founder}</h5>
                                    <p className="font-inter text-xs text-slate-500 mb-2">{deal.founderTitle} • Team of {deal.teamSize || 5} members</p>
                    ...
                    <div>
                        <h4 className="font-geist text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-2">Investment Thesis</h4>
                        <p className="font-inter text-sm text-slate-600 leading-relaxed border-l-2 border-[#102c1e]/20 pl-4 py-1">
                ...
                <div className="p-6 border-t border-slate-100 bg-white flex items-center gap-3 shrink-0">
                    <button className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-[#102c1e] text-white rounded-xl font-geist text-sm font-bold hover:bg-[#0a1c13] transition-colors shadow-md">
                        <Check className="w-4 h-4" /> Approve & Advance
                    </button>
                    <button className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-white border border-slate-200 text-[#102c1e] rounded-xl font-geist text-sm font-bold hover:bg-slate-50 transition-colors">
                        Reject
                    </button>
                </div>
