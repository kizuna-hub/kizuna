    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-2.5">
                <label className="font-geist text-[11px] font-bold text-slate-500 uppercase tracking-widest">{label}</label>
        ...
        <div className="min-h-screen bg-[#fafafa] font-inter">
            ...
            <div className="sticky top-0 z-20 bg-white/90 backdrop-blur-md border-b border-[#102c1e]/8 px-8 py-4 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <a href="/investor/deal-flow" className="flex items-center gap-1.5 text-slate-400 hover:text-[#102c1e] transition-colors font-geist text-sm font-bold">
                        <ArrowLeft className="w-4 h-4" /> Back
                    </a>
                    <div className="w-px h-5 bg-[#102c1e]/10" />
                    <div>
                        <h1 className="font-outfit font-black text-[#102c1e] text-xl">Pro-Rata Simulator</h1>
                        <p className="font-geist text-[10px] text-slate-400 font-bold uppercase tracking-widest">SnapMoney · Series A</p>
                    </div>
                </div>
                <div className="flex items-center gap-2">
                    <button className="flex items-center gap-2 bg-[#102c1e] text-white font-geist font-black text-sm px-4 py-2 rounded-xl hover:bg-[#0a1c13] transition-colors shadow-md">
                        <Target className="w-4 h-4 text-[#a1e2b6]" />
                        Tạo Term Sheet
                    </button>
                    <button className="flex items-center gap-2 border border-[#102c1e]/10 text-[#102c1e] font-geist font-bold text-sm px-4 py-2 rounded-xl hover:bg-[#102c1e]/5 transition-colors">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-5 space-y-5">
                        ...
                        <div className="bg-white rounded-3xl border border-[#102c1e]/10 shadow-sm p-6 space-y-7">
                            <div>
                                <h2 className="font-outfit font-black text-[#102c1e] text-xl mb-1">Thông số đầu tư</h2>
                                <p className="font-inter text-xs text-slate-500">Kéo slider để xem pha loãng cổ phần theo thời gian thực.</p>
                            </div>
                        ...
                        <div className="bg-[#102c1e] rounded-3xl p-6 text-white relative overflow-hidden">
                            ...
                            <h3 className="font-outfit font-black text-white text-lg mb-5 relative">Kết quả tính toán</h3>
                            <div className="relative space-y-3">
                                {[
                                    ...
                                    <div key={i} className={cn(
                                        ...
                                        <span className="font-geist text-xs text-white/60">{item.label}</span>
                    ...
                    <div className="lg:col-span-7 space-y-5">
                        ...
                        <div className="bg-white rounded-3xl border border-[#102c1e]/10 shadow-sm p-6">
                            <div className="flex items-start justify-between mb-6">
                                <div>
                                    <h2 className="font-outfit font-black text-[#102c1e] text-xl">Cơ cấu sở hữu sau đầu tư</h2>
                                    <p className="font-geist text-[10px] text-slate-400 mt-1 font-bold uppercase tracking-widest">Post-money · Fully diluted</p>
                                </div>
                                <div className="flex items-center gap-1.5 bg-[#a1e2b6]/15 border border-[#a1e2b6]/30 px-3 py-1.5 rounded-xl">
                                    ...
                                    <span className="font-geist text-[10px] font-black text-[#102c1e]">Live</span>
                                </div>
                            </div>
                                ...
                                <div className="flex-1 space-y-2.5">
                                    ...
                                    <div className="flex items-center justify-between bg-[#a1e2b6]/10 border border-[#a1e2b6]/30 rounded-xl px-3.5 py-2.5">
                                        <div className="flex items-center gap-2.5">
                                            ...
                                            <span className="font-geist text-xs font-black text-[#102c1e]">You (New Investor)</span>
                                        </div>
                                    ...
                                    {sim.holders.map(h => (
                                        <div key={h.id} className="flex items-center justify-between px-3.5 py-2 rounded-xl hover:bg-[#fafafa] transition-colors group">
                                            <div className="flex items-center gap-2.5">
                                                ...
                                                <span className="font-geist text-xs font-bold text-slate-600">{h.name}</span>
                                            </div>
                        ...
                        <div className="bg-white rounded-3xl border border-[#102c1e]/10 shadow-sm overflow-hidden">
                            <div className="px-6 py-4 border-b border-[#102c1e]/5 flex items-center justify-between">
                                <h3 className="font-outfit font-black text-[#102c1e] text-lg">So sánh trước / sau đầu tư</h3>
                                <span className="font-geist text-[10px] font-bold text-slate-400 uppercase tracking-widest">Fully diluted basis</span>
                            </div>

                            <table className="w-full text-left">
                                <thead>
                                    <tr className="border-b border-[#102c1e]/5">
                                        <th className="px-6 py-3 font-geist text-[9px] font-bold text-slate-400 uppercase tracking-widest">Cổ đông</th>
                                        <th className="px-4 py-3 font-geist text-[9px] font-bold text-slate-400 uppercase tracking-widest text-right">Trước</th>
                                        <th className="px-4 py-3 font-geist text-[9px] font-bold text-slate-400 uppercase tracking-widest text-right">Sau</th>
                                        <th className="px-6 py-3 font-geist text-[9px] font-bold text-slate-400 uppercase tracking-widest text-right">Pha loãng</th>
                                    </tr>
                                </thead>
                                        ...
                                        <tr key={h.id} className="hover:bg-[#fafafa] transition-colors">
                                            <td className="px-6 py-3">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="font-geist text-sm font-bold text-[#102c1e]">{h.name}</span>
                                                </div>
                                            </td>
                                    ...
                                    <tr className="bg-[#a1e2b6]/8">
                                        <td className="px-6 py-3">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="font-geist text-sm font-black text-[#102c1e]">You (New)</span>
                                                <span className="font-geist text-[9px] font-black bg-[#102c1e] text-white px-1.5 py-0.5 rounded-full">NEW</span>
                                            </div>
                                        </td>
                        ...
                        <div className="bg-[#102c1e]/[0.02] border border-[#102c1e]/8 rounded-2xl p-5 flex items-start gap-3">
                            ...
                            <div>
                                <p className="font-geist font-bold text-xs text-[#102c1e] mb-0.5">Pro-Rata Right</p>
