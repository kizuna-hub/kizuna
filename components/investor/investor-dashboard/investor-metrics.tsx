        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5 mb-8">
            <div className="bg-gradient-to-br from-[#102c1e] to-[#16452a] rounded-3xl p-6 text-white shadow-[0_8px_30px_rgb(16,44,30,0.15)] relative overflow-hidden group">
                ...
                <div className="inline-flex items-center gap-1.5 bg-white/10 px-2.5 py-1 rounded-lg border border-white/10 text-[10px] font-bold">
                    <TrendingUp className="w-3 h-3 text-[#a1e2b6]" />
                    <span className="text-[#a1e2b6]/90">+5 Deal mới tuần này</span>
                </div>
            </div>
            ...
            <div className="bg-white border border-zinc-200 rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow relative group">
                ...
                <p className="text-[10px] font-bold text-[#102c1e] flex items-center gap-1.5"><TrendingUp className="w-3 h-3 text-[#a1e2b6]" /> Tăng 15% so với tháng trước</p>
            </div>
            ...
            <div className="bg-white border border-zinc-200 rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow relative group">
                ...
                <p className="text-[10px] font-bold text-slate-600 flex items-center gap-1.5"><span className="relative flex h-2 w-2"><span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#102c1e]/40 opacity-75"></span><span className="relative inline-flex rounded-full h-2 w-2 bg-[#102c1e]/60"></span></span> Chờ duyệt từ Founder</p>
            </div>
        </div>
    );
};