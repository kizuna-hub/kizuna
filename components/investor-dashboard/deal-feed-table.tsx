            ...
            {projects.map(project => (
                ...
                >
                    ...
                    <div className="col-span-3 flex items-center gap-2">
                        ...
                        <span className="text-sm font-bold text-kizuna-text-main truncate">{project.metrics}</span>
                    </div>
                    ...
                    <div className="col-span-1 flex justify-end">
                        <Button
                            variant="outline"
                            size="sm"
                            className="border-kizuna-border text-kizuna-text-main hover:bg-white font-bold h-8 px-3 text-xs uppercase tracking-tight"
                        >
                            Xem
                        </Button>
                    </div>
