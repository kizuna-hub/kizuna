        ...
        <div className="lg:col-span-4 flex flex-col space-y-8 pt-8">
          <div>
            ...
            <p className="text-kizuna-text-muted text-base">
              Set up your unified profile to engage with the ecosystem on your terms.
            </p>
          </div>
          ...
          <div className="p-6 bg-white border border-kizuna-border rounded-2xl shadow-sm">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                <p className="text-sm font-medium text-kizuna-text-muted">Ecosystem Activity</p>
            ...
            <p className="text-sm text-kizuna-text-muted">
              We use this data to deliver highly relevant deal flow, talent, and founders.
            </p>
          </div>
            ...
            <div className="px-10 py-6 border-t border-zinc-100 bg-zinc-50 flex items-center justify-between">
              {onBack ? (
                <button
                  type="button"
                  onClick={onBack}
                  className="text-zinc-500 hover:text-zinc-900 font-medium px-4 py-2"
                >
                  Back
                </button>
              ) : <div />}
              ...
              <button
                ...
                className={`bg-kizuna-primary text-white rounded-lg px-6 py-3 font-medium transition-none ${
