...
const SECTORS = ["AI & ML", "EdTech", "FinTech", "Web3", "Social Impact"]
...
export function ThesisStep({ data, updateData }: ThesisStepProps) {
  ...
  return (
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="space-y-4">
        <div>
          <h3 className="text-sm font-medium text-kizuna-text-main">Preferred Stage</h3>
          <p className="text-sm text-kizuna-text-muted mt-1">At which stage do you typically invest?</p>
        </div>
        <div className="flex flex-wrap gap-3">
          {STAGES.map(stage => (
            <SelectablePill
